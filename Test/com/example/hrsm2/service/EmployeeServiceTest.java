...
class EmployeeServiceTest {
    ...
    void addEmployee(String ID, String FirstName, String LastName, String Email, String Phone, String Department, double Salary) {
        ...
        assertNotNull(testEmployeeId, "Employee ID should be generated");
    }
    ...
    void searchEmployees(String ID) {
        List<Employee> results = operation.searchEmployees(ID);
        assertNotNull(results, "Search results should not be null");
        assertTrue(results.stream().anyMatch(e -> e.getId().equals(testEmployeeId)), "Search should return the test employee");
    }*/
